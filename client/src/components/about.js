...
export default props =>{
    ...
    return(
        ...
        <div className="container">
            ...
            <p className='text-faded'>Laura is the Founder and Managing Partner of Accel Impact, which includes Accel.AI, a global Non-Profit Institute lowering the barriers to entry in engineering artificial intelligence, and the Latinx in AI Coalition an initiative to create opportunity for Latinx in AI. She has been described as a natural and versatile leader with a passion for AI, Computer Science, Research, and Psychology. She has a Bachelors of Science in Biology, Physical Science, and Human Development. She jumpstarted her career in software engineering at Intuit revamping their Quickbooks online platform. She is a Director with Women Who Code, a global non-profit dedicated to inspiring women to excel in technology careers.</p>
            <div className='row'>
